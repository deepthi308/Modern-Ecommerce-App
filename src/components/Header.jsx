...
const Header = () => {
    ...
    <header className="header-top-strip py-3">
      <div className="container-xxl">
        <div className="row">
          ...
          <div className="col-6">
            <p className="text-end text-white mb-0">Hotline: <a href="tel:+91 8264954234" className='text-white'>+91 8264954234</a></p>
          </div>
        </div>
      </div>
    </header>
    <header className="header-upper py-3">
      <div className="container-xxl">
        <div className="row align-items-center">
          <div className="col-2">
            <h2><Link to="/about" className="text-white">Dev Deepthi</Link></h2>
          </div>
          <div className="col-5">
  ...
  <button className="btn btn-secondary dropdown-toggle bg-transparent border-0 d-flex gap-15" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
    <img src={Menu} alt="" />
